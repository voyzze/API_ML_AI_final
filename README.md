...
- [jupyter代码文件](https://github.com/voyzze/API_ML_AI_final/blob/master/API_final.html)代码文件展示了使用百度图像识别中的动物识别、植物识别、果蔬识别以及通用物体识别。可看到里面所有的图片都识别出来了，而且还有概率细分、品种细分等等。最后一个通用物体api的调用，图中有8个人，可是只能识别出一个人。
